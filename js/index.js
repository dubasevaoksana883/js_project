...
class Game {
  constructor(){
        ...
        items: [
          ...
          },
          {
            ...
            onclick: function (event) {
              ...
              namePart === "knight" || namePart === "safe" || namePart === "room-chest" ? changeOnclick(event.target, function (event){
                var x = document.querySelector(".question")
                var t = document.querySelector(".text")
                namePart === "safe" || namePart === "room-chest" ?
                  x.style.display === "none" && !t ? elixRes = true : null : null
                if (x && !t && elixRes){
                ...
                var timer = setInterval(function(){
                  ...
                  if (!document.querySelector(".text")){
                    ...
                    answBtn.onclick = function(event){
                      ...
                      parts.filter(el =>el.name === "room-chest")[0].res2 (event)
                    }
                  }
                }.bind(this), 100)
              }.bind(this))
    ...
    this.scenarioGame = name => {
      ...
      var currentFunc = curentPart.res ? curentPart.res :/* curentPart.res2 ? curentPart.res2 :*/ null
      if (currentFunc) {
        var timer = setInterval(function(){
          console.log("interval", this)
          if (!document.querySelector(".text")){
